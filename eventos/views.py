...
def gerar_certificado(request, id):
    ...
    # Captura os caminhos dos arquivos, template_certificado e arimo
    ...
    # Pega os participantes do evento e passa por cada um deles
    for participante in evento.participantes.all():
        # Abre o template do certificado em branco.
        img = Image.open(path_template)
        # Cria um objeto que escreve dentro da imagem do template
        ...
        # Salva em memoria com o BytesIo, pois o django não entende o tipo do arquivo
        output = BytesIO()
        img.save(output, format="PNG", quality=100)
        output.seek(0)
        
        # Aqui comverte o tipo de dados byte 
